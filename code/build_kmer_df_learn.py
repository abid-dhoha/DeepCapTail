"""
We build df_learn, which consists of the learning matrix for the machine learning model.
It has the ids of the data entries, the frequency of kmer without normalization, and
the corresponding labels if they were provided in the input
"""
